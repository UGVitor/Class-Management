...
public class TipodeSalaControllerTest {
    ...
    @Test
    public void deveDeletarTipoSala_ComIdExistente_RetornarComStatus204() {
        testClient
                .delete()
                .uri("/api/v1/tiposalas/100")
                .exchange()
    ...
    @Test
    public void deveDeletarTipoSala_ComIdInexistente_RetornarComStatus404() {
        testClient
                .delete()
                .uri("/api/v1/tiposalas/0")
                .exchange()
