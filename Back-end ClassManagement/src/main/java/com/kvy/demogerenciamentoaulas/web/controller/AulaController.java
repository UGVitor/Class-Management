...
public class AulaController {
    ...
    @PostMapping
    public ResponseEntity<TurmaResponseDto> createAula(@Valid @RequestBody AulaCreateDto aulaCreateDto) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TurmaResponseDto> getAulaById(@PathVariable Long id) {
    ...
    @GetMapping
    public ResponseEntity<List<TurmaResponseDto>> getAulaAll(@PathVariable Long id) {
